...
const applicant = (state = {}, action) => {
  switch (action.type) {
    case APPLICANT_ACTIONS.FILL_FORM:
      ...
      return {
        ...action.payload,
        accepted_at_prime: (action.payload.accepted_at_prime === null) ? action.payload.accepted_at_prime : action.payload.accepted_at_prime.toString(),
        applied_at_prime: (action.payload.applied_at_prime === null) ? action.payload.applied_at_prime : action.payload.applied_at_prime.toString(),
        msp_tech_scholar: (action.payload.msp_tech_scholar === null) ? action.payload.msp_tech_scholar : action.payload.msp_tech_scholar.toString(),
        applied_for_msp: (action.payload.applied_for_msp === null) ? action.payload.applied_for_msp : action.payload.applied_for_msp.toString(),
